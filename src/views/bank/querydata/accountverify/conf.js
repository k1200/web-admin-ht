import { fn_api__bank_queryDepBankInoutss } from '@/api/bank';
export default {
  ...
  methods: {
    ...
    fn_handle__get_list(form = this.query_params) {
      this.loading = true;
      fn_api__bank_queryDepBankInoutss(this.fn_format__reqdata(form))
        .then(res => {
    ...
    fn_click__reset_search() {
      this.query_params = { tranDate: '', inoutFlag: '' };
    },
